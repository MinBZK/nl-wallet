...
class WalletAddIssuedCardUseCaseImpl implements WalletAddIssuedCardUseCase {
  final WalletCardRepository walletCardRepository;
  final TimelineAttributeRepository timelineAttributeRepository;

  WalletAddIssuedCardUseCaseImpl(this.walletCardRepository, this.timelineAttributeRepository);
