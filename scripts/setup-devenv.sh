...
generate_demo_issuer_issuance_key_pairs mvrc
DEMO_ISSUER_KEY_MVRC_ISSUER=$(< "${TARGET_DIR}/demo_issuer/mvrc.issuer.key.der" ${BASE64})
export DEMO_ISSUER_KEY_MVRC_ISSUER
DEMO_ISSUER_CRT_MVRC_ISSUER=$(< "${TARGET_DIR}/demo_issuer/mvrc.issuer.crt.der" ${BASE64})
export DEMO_ISSUER_CRT_MVRC_ISSUER
DEMO_ISSUER_KEY_MVRC_TSL=$(< "${TARGET_DIR}/demo_issuer/mvrc.tsl.key.der" ${BASE64})
export DEMO_ISSUER_KEY_MVRC_TSL
DEMO_ISSUER_CRT_MVRC_TSL=$(< "${TARGET_DIR}/demo_issuer/mvrc.tsl.crt.der" ${BASE64})
export DEMO_ISSUER_CRT_MVRC_TSL
DEMO_ISSUER_KEY_MVRC_WRPAC=$(< "${TARGET_DIR}/demo_issuer/mvrc.wrpac.key.der" ${BASE64})
export DEMO_ISSUER_KEY_MVRC_WRPAC
DEMO_ISSUER_CRT_MVRC_WRPAC=$(< "${TARGET_DIR}/demo_issuer/mvrc.wrpac.crt.der" ${BASE64})
export DEMO_ISSUER_CRT_MVRC_WRPAC
...
cp "${DEVENV}/com.example.museum_maandkaart.json" "${DEVENV}/org.iso.18013.5.1.mDL.json" "${DEVENV}/org.iso.7367.1.mVRC.json" "${PACF_ISSUANCE_SERVER_DIR}"
cp "${DEVENV}/com.example.jum.bonuskaart.json" "${DEVENV}/com.example.museum_maandkaart.json" "${DEVENV}/org.iso.18013.5.1.mDL.json" "${DEVENV}/org.iso.7367.1.mVRC.json" "${BASE_DIR}/wallet_core/tests_integration"
...
export ISSUER_METADATA_MVRC_PATH="org.iso.7367.1.mVRC.json"
