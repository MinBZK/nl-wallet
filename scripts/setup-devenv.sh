...
p11tool --login --write --secret-key="$(openssl rand 32 | xxd -p -c 0)" --set-pin "${HSM_USER_PIN}" --label="pin_public_disclosure_protection_key" "$(p11tool --list-token-urls | grep "SoftHSM")"
