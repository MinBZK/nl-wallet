...
cp "${DEVENV}/com.example.museum_maandkaart.mdoc.json" "${DEVENV}/org.iso.18013.5.1.mDL.mdoc.json" "${PACF_ISSUANCE_SERVER_DIR}"
cp "${DEVENV}/com.example.jum.bonuskaart.mdoc.json" "${DEVENV}/org.iso.18013.5.1.mDL.mdoc.json" "${BASE_DIR}/wallet_core/tests_integration"
