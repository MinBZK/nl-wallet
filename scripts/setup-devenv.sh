...
generate_demo_issuer_issuance_key_pairs mvc
DEMO_ISSUER_KEY_MVC_ISSUER=$(< "${TARGET_DIR}/demo_issuer/mvc.issuer.key.der" ${BASE64})
export DEMO_ISSUER_KEY_MVC_ISSUER
DEMO_ISSUER_CRT_MVC_ISSUER=$(< "${TARGET_DIR}/demo_issuer/mvc.issuer.crt.der" ${BASE64})
export DEMO_ISSUER_CRT_MVC_ISSUER
DEMO_ISSUER_KEY_MVC_TSL=$(< "${TARGET_DIR}/demo_issuer/mvc.tsl.key.der" ${BASE64})
export DEMO_ISSUER_KEY_MVC_TSL
DEMO_ISSUER_CRT_MVC_TSL=$(< "${TARGET_DIR}/demo_issuer/mvc.tsl.crt.der" ${BASE64})
export DEMO_ISSUER_CRT_MVC_TSL
DEMO_ISSUER_KEY_MVC_WRPAC=$(< "${TARGET_DIR}/demo_issuer/mvc.wrpac.key.der" ${BASE64})
export DEMO_ISSUER_KEY_MVC_WRPAC
...
cp "${DEVENV}/com.example.museum_maandkaart.json" "${DEVENV}/org.iso.18013.5.1.mDL.json" "${DEVENV}/org.iso.7367.2.1.mVC.json" "${PACF_ISSUANCE_SERVER_DIR}"
cp "${DEVENV}/com.example.jum.bonuskaart.json" "${DEVENV}/com.example.museum_maandkaart.json" "${DEVENV}/org.iso.18013.5.1.mDL.json" "${DEVENV}/org.iso.7367.2.1.mVC.json" "${BASE_DIR}/wallet_core/tests_integration"
...
export ISSUER_METADATA_MVC_PATH="org.iso.7367.2.1.mVC.json"
