...
cargo install cargo-expand --locked --version 1.0.110
cargo install cargo-llvm-cov --locked --version 0.6.16
cargo install cargo-audit --locked --version 0.21.2
cargo install cargo-nextest --locked --version 0.9.99
cargo install flutter_rust_bridge_codegen --locked --version 2.9.0
