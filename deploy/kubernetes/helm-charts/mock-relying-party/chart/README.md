...
### Mock Relying Party parameters

| Name                                 | Description                              | Value |
| ------------------------------------ | ---------------------------------------- | ----- |
| `mockRelyingParty.hostname`          | Hostname for the mock relying party      | `nil` |
| `mockRelyingParty.contextPath`       | Context path for the mock relying party  | `nil` |
| `mockRelyingParty.walletWebFilename` | Filename for the wallet web              | `nil` |
| `mockRelyingParty.walletWebSha256`   | SHA-256 checksum for the wallet web file | `nil` |
