...
class RustCoreImpl implements RustCore {
  ...
  factory RustCoreImpl(ExternalLibrary dylib) => RustCoreImpl.raw(RustCorePlatform(dylib));
...
class RustCoreWire implements FlutterRustBridgeWireBase {
  ...
  RustCoreWire(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  RustCoreWire.fromLookup(ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) lookup)
      : _lookup = lookup;
