...
import '../get_wallet_card_update_issuance_request_id_usecase.dart';

const _kDrivingLicenseId = 'DRIVING_LICENSE';
const _kDrivingLicenseRenewedId = 'DRIVING_LICENSE_RENEWED';

class GetWalletCardUpdateIssuanceRequestIdUseCaseImpl implements GetWalletCardUpdateIssuanceRequestIdUseCase {
  final IssuanceResponseRepository issuanceResponseRepository;

  GetWalletCardUpdateIssuanceRequestIdUseCaseImpl(this.issuanceResponseRepository);
