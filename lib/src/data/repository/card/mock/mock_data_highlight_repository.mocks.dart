part of 'mock_data_highlight_repository.dart';

const _kMockPidDataAttribute = DataHighlight(
...
const _kMockHealthInsuranceDataAttribute = DataHighlight(
  title: 'Naam: Willeke de Bruijn',
  subtitle: 'Geldig t/m 1 januari 2024',
  image: null,
);
