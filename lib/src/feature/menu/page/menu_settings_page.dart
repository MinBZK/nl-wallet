      ...
      child: ListView(
        children: [
          ...
          MenuRow(
            ...
            icon: Icons.key,
            onTap: () => PlaceholderScreen.show(context, locale.menuSettingsPageChangePinCta),
          ),
          const Divider(height: 1),
          MenuRow(
            label: locale.menuSettingsPageSetupBiometricsCta,
            icon: Icons.fingerprint,
            onTap: () => PlaceholderScreen.show(context, locale.menuSettingsPageSetupBiometricsCta),
          ),
          const Divider(height: 1),
          MenuRow(
            label: locale.menuSettingsPageChangeLanguageCta,
            icon: Icons.translate,
            onTap: () => PlaceholderScreen.show(context, locale.menuSettingsPageChangeLanguageCta),
          ),
          const Divider(height: 1),
          MenuRow(
            label: locale.menuSettingsPageClearDataCta,
            icon: Icons.delete_outline,
            onTap: () => PlaceholderScreen.show(context, locale.menuSettingsPageClearDataCta),
          ),
          const Divider(height: 1),
        ],
      ),
