...
class IssuanceConfirmPinPage extends StatelessWidget {
  ...
  Widget _buildNeutralHeader(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text(
          locale.issuanceConfirmPinTitle,
          style: Theme.of(context).textTheme.headline2,
        ),
        const SizedBox(height: 8),
        Text(
          locale.issuanceConfirmPinDescription,
  ...
  Widget _buildErrorHeader(BuildContext context, int attempts) {
    ...
    return Column(
      ...
      children: [
        Text(
          locale.issuanceConfirmPinErrorTitle,
          style: Theme.of(context).textTheme.headline2?.copyWith(color: Theme.of(context).errorColor),
        ),
        const SizedBox(height: 8),
        Text(
          locale.issuanceConfirmPinErrorDescription(attempts),
