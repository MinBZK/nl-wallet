...
fn assert_generated_certificate(crt_file: &ChildPath, expected_cn: &str) -> Result<()> {
...
fn happy_flow() -> Result<()> {
    ...
    assert_generated_certificate(&ca_crt, "test-ca")?;
    ...
    // Generate mdl certificate
    {
        ...
        assert_generated_certificate(&mdl_crt, "test-mdl")?;
    }
    ...
    // Generate reader-auth certificate
    {
        ...
        assert_generated_certificate(&rp_auth_crt, "test-reader-auth")?;
    }
