<script lang="ts">
	import 'nl-wallet-web'

	import logo from '$lib/assets/adam_logo.svg';
	import kloveniersburgwal from '$lib/assets/70892-kloveniersburgwal-03-17apr2023-e-v-eis940.jpg';
...
<main>
	<header>
		<div class="logo">
			<span class="logoset">
				<img src="{logo}" class="screen-logo" alt="Gemeente Amsterdam">
			</span>
			<div class="logotexts">
	...
	<article>
		...
		<p>
			Bewijs dat u ouder bent dan 18 jaar of 65 jaar door uzelf bekend te maken met de volgende
			gegevens:
		</p>
		<ul>
			<li>Ouder dan 18</li>
		...
		<div>
			<nl-wallet-button text="18+ bewijzen met NL Wallet" on:close={handleClose}></nl-wallet-button>
		</div>
	</article>
</main>
