...
pub const TRANSLATIONS: Translations = Translations {
    en: Words {
        ...
        index_needs_bullet_pre: "You need the ",
        index_needs_bullet_post: " version of the NL Wallet app.",
        index_icon_pre: "You can recognise this version by the word ‘",
        index_icon_post: "’ on the app icon.",
        index_opened_from: "Did you open this page from NL Wallet? Make sure you are using the right version.",
        index_info_pre: "You can find more information about this development at ",
    ...
    nl: Words {
        ...
        index_needs_bullet_pre: "Je hebt ",
        index_needs_bullet_post: "-versie van de NL Wallet app nodig.",
        index_icon_pre: "Je herkent deze versie aan het woord ‘",
        index_icon_post: "’ op het app-icoon.",
        index_opened_from: "Heb je deze pagina geopend vanuit NL Wallet? Dan gebruik je de goede versie.",
        index_info_pre: "Meer informatie over deze ontwikkeling vind je op ",
        index_info_link: "edi.pleio.nl",
        index_info_post: ".",
...
pub struct Words<'a> {
    ...
    pub index_needs_bullet_pre: &'a str,
    pub index_needs_bullet_post: &'a str,
    pub index_icon_pre: &'a str,
    pub index_icon_post: &'a str,
    pub index_opened_from: &'a str,
    pub index_info_pre: &'a str,
    pub index_info_link: &'a str,
    pub index_info_post: &'a str,
