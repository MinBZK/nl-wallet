        ...
        let attributes = IndexMap::from_iter(
            vec![
                ...
                Some((
                    ...
                    Attribute::Text(self.birth.date.date.format("%Y-%m-%d").to_string()),
                )),
                Some((String::from(PID_AGE_OVER_18), Attribute::Bool(is_over_18))),
                Some((String::from(PID_BSN), Attribute::Text(self.bsn))),
                Some((
