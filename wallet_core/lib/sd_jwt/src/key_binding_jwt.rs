...
pub(crate) fn kb_jwt_validation(expected_aud: &str) -> Validation {
...
mod test {
    ...
    async fn test_parse_and_verify_iat(
        ...
        validation_options.leeway = leeway;
        validation_options.set_required_spec_claims(&["aud"]);
