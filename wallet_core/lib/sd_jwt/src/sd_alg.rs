...
/// Named Information Hash Algorithms used by SD-JWT for disclosure digests. Names come from the
/// [IANA registry](https://www.iana.org/assignments/named-information/named-information.xhtml).
#[derive(
...
/// Returns a hasher implementation for this algorithm. Currently, only `sha-256` is supported. Other variants return
/// `SdAlgHasherNotImplemented`.
impl SdAlg {
