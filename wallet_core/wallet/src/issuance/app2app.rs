...
mod test {
    ...
    #[case(
        StatusCode::TEMPORARY_REDIRECT,
        HeaderValue::from_bytes("not_a_url".as_bytes().to_vec()).ok(),
        None,
        None,
    ...
    #[case(
        StatusCode::TEMPORARY_REDIRECT,
        Some(unsafe { HeaderValue::from_bytes_unchecked("🦀".as_bytes().to_vec()) }),
        None,
        None,
    ...
    #[case(
        StatusCode::TEMPORARY_REDIRECT,
        HeaderValue::from_bytes("https://preprod.example.com/saml/idp/request_authentication".as_bytes().to_vec()).ok(),
        None,
        None,
    ...
    #[case(
        StatusCode::TEMPORARY_REDIRECT,
        HeaderValue::from_bytes("https://preprod.example.com/saml/idp/request_authentication?hello".as_bytes().to_vec()).ok(),
        None,
        None,
