...
mod tests {
    ...
    async fn test_wallet_lock_unlock(
        ...
        let result = VerifiedJwt::sign_with_sub(result_claims, &ACCOUNT_SERVER_KEYS.instruction_result_signing_key)
            .await
            .unwrap()
            .into();
    ...
    async fn test_wallet_unlock_error_instruction_result_validation() {
        ...
        let result = VerifiedJwt::sign_with_sub(result_claims, &other_key)
            .await
            .unwrap()
            .into();
