// The const generated by uniffi::include_scaffolding! contains a large const MetadataBuffer array.
#![expect(clippy::large_const_arrays, reason = "generated by uniffi")]
