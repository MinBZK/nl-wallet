...
///
/// * `r#type` - A short string category for the error. This is the only mandatory field. Its type is generic and
...
/// * `status` - An optional HTTP status code for the error response. In the `IntoResponse` implementation this will be
...
/// * `extra` - This may contain extra key-value pairs of the JSON object, as allowed by the RFC. As this uses both the
