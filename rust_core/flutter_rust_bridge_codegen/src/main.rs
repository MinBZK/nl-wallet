...
const DART_OUTPUT: &str = concat!(env!("CARGO_MANIFEST_DIR"), "/../../wallet-app/lib/bridge_generated.dart");
/// Path of output generated C code
const C_OUTPUT: &str = concat!(env!("CARGO_MANIFEST_DIR"), "/../../wallet-app/ios/Runner/bridge_generated.h");
