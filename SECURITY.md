...
## This repository is not (yet) intended for production

Keep in mind that this repository doesn't (yet) contain code intended for a production scenario. The following procedure is mainly meant for production code. However, we'd still like to be informed about any potential vulnerability present.
...
And reference the "Ministerie van Binnenlandse Zaken, EDI Wallet project" in your report.
