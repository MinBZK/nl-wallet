...
abstract class BinarySerializer {
  ...
  void serializeUint8(int val) {
    if (val.bitLength > 8) {
      throw Exception('The integer literal $val can\'t be represented in 8 bits.');
    }
  ...
  void serializeUint16(int val) {
    if (val.bitLength > 16) {
      throw Exception('The integer literal $val can\'t be represented in 16 bits.');
    }
  ...
  void serializeUint32(int val) {
    if (val.bitLength > 32) {
      throw Exception('The integer literal $val can\'t be represented in 32 bits.');
    }
  ...
  void serializeInt8(int value) {
    if (value.bitLength > 7) {
      throw Exception('The integer literal $value can\'t be represented in 8 bits.');
    }
  ...
  void serializeInt16(int value) {
    if (value.bitLength > 15) {
      throw Exception('The integer literal $value can\'t be represented in 16 bits.');
    }
  ...
  void serializeInt32(int value) {
    if (value.bitLength > 31) {
      throw Exception('The integer literal $value can\'t be represented in 32 bits.');
    }
