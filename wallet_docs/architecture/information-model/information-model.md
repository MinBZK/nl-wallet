...
TODO: add references batch issuance
...
#### Disclosure Event
An event that relates to (attempted) disclosure of data to a relying party. The relying party involved is also stored along with the event.
