...
- When the wallet has been revoked by the Wallet Provider, it will now inform the
  user and reset the wallet to its initial state if the revocation was initiated
