...
| Credential Type metadata     | A metadata document that describes an SD-JWT Credential. (SD-JWT VC Type metadata spec)                                                                     |
| Credential metadata          | A metadata document that describes a Credential of either format, as part of the Credential Issuer Metadata. (`credential_metadata` in the OpenID4VCI spec) |
...
| Status List                  | A digitally signed document that describes th revocation status for a set of credentials. (Token Status List spec)                                          |
| Update Policy                | A policy describing app versions, information messages and mandatory updates                                                                                |
