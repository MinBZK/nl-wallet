...
|---------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------|
| **1**   | **PRIMARY SCENARIO**                                                                                                                                                                    |                                                                                |
| **1.1** | **System displays screen 'Card'**<ul><li>[Card title]</li><li>Actions: Details in this card, Card activities, About the Issuer, Help, Replace card via DigiD (When PID), Back</li></ul> |                                                                                |
...
| 1.1e    | User selects Replace Card via DigiD                                                                                                                                                     | Go to: [UC3.2 Renew PID](UC3.2_RenewPid.md)                                    |
| 1.1f    | User selects Back                                                                                                                                                                       | Back                                                                           |
| **2**   | **INSPECT CARD DETAILS**                                                                                                                                                                |                                                                                |
| **2.1** | **System displays screen 'Card details'**<ul><li>Lists all data from the selected card</li><li>Actions: Details Incorrect, Help, Back</li></ul>                                         |                                                                                |
