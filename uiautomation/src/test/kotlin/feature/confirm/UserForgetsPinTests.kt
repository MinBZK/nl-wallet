...
class UserForgetsPinTests : TestBase() {
    ...
    @DisplayName("$USE_CASE.1 The app explains that the user has to reset the wallet in order to regain access. 2 The app explains that upon resetting the wallet, data CANNOT be recovered. 3 The app offers an entrance to resetting the app. 4 The user can go back to the PIN entry screen. [${JIRA_ID}]")
    fun verifyForgotPin() {
        setUp()
        assertAll(
