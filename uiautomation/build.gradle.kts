...
dependencies {
    browserstackAgent("com.browserstack:browserstack-java-sdk:1.65.1")
...
tasks.register<Test>("testA11yBatch3") {
    useJUnitPlatform {
        includeTags("a11yBatch3")
        exclude("suite/**")
    }
}

tasks.register<Test>("testAllAndroids") {
    useJUnitPlatform {
        includeTags("onallandroids")
        exclude("suite/**")
    }
}
