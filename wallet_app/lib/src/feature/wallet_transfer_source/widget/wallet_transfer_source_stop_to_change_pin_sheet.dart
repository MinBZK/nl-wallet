...
/// when the user is requesting to change her pin during the wallet transfer
/// on the source device.
class WalletTransferSourceStopToChangePinSheet extends StatelessWidget {
  ...
  const WalletTransferSourceStopToChangePinSheet({
  ...
  Widget build(BuildContext context) {
    return ConfirmActionSheet(
      title: context.l10n.walletTransferSourceStopSheetForgotPinVariantTitle,
      description: context.l10n.walletTransferSourceStopSheetForgotPinVariantDescription,
      ...
      builder: (BuildContext context) {
        return WalletScrollbar(
          child: SingleChildScrollView(
            child: WalletTransferSourceStopToChangePinSheet(
