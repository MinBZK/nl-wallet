      ...
      child: ListView(
        ...
        children: [
          Padding(
            ...
            child: Text(
              context.l10n.menuMainPageGreeting(name),
              style: context.textTheme.displayMedium,
            ),
          ),
          const Divider(height: 1),
          MenuRow(
            label: context.l10n.menuMainPageHelpCta,
            icon: Icons.help_outline,
            onTap: () => PlaceholderScreen.show(context),
          ),
          const Divider(height: 1),
          MenuRow(
            label: context.l10n.menuMainPageHistoryCta,
            icon: Icons.history,
            onTap: () => Navigator.restorablePushNamed(context, WalletRoutes.walletHistoryRoute),
          ),
          const Divider(height: 1),
          MenuRow(
            label: context.l10n.menuMainPageSettingsCta,
            icon: Icons.settings_outlined,
            onTap: () => context.read<MenuBloc>().add(MenuSettingsPressed()),
          ),
          const Divider(height: 1),
          MenuRow(
            label: context.l10n.menuMainPageAboutCta,
          ...
          if (showDesignSystemRow)
            MenuRow(
              label: context.l10n.menuMainPageDesignCta,
              ...
              child: OutlinedButton(
                ...
                child: Row(
                  children: [
                    ...
                    Text(context.l10n.menuMainPageLockCta),
                  ],
                ),
              ),
            ),
