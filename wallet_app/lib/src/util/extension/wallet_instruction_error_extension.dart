...
extension WalletInstructionErrorExtension on WalletInstructionError {
  CheckPinResult asCheckPinResult() {
    return switch (this) {
      WalletInstructionError_IncorrectPin(:final attemptsLeftInRound, :final isFinalRound) => CheckPinResultIncorrect(
        attemptsLeftInRound: attemptsLeftInRound,
        isFinalRound: isFinalRound,
      ),
      WalletInstructionError_Timeout(:final timeoutMillis) => CheckPinResultTimeout(
