...
abstract class WalletCoreApiImplPlatform extends BaseApiImpl<WalletCoreWire> {
  ...
  @protected
  RustStreamSink<List<AppNotification>> dco_decode_StreamSink_list_app_notification_Dco(dynamic raw);
  ...
  @protected
  AppNotification dco_decode_app_notification(dynamic raw);
  ...
  @protected
  List<DisplayTarget> dco_decode_list_display_target(dynamic raw);
  ...
  @protected
  RustStreamSink<List<AppNotification>> sse_decode_StreamSink_list_app_notification_Dco(SseDeserializer deserializer);
  ...
  @protected
  AppNotification sse_decode_app_notification(SseDeserializer deserializer);
  ...
  @protected
  List<DisplayTarget> sse_decode_list_display_target(SseDeserializer deserializer);
  ...
  @protected
  ffi.Pointer<wire_cst_list_prim_u_8_strict> cst_encode_StreamSink_list_app_notification_Dco(
    RustStreamSink<List<AppNotification>> raw,
  ) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    return cst_encode_String(
      raw.setupAndSerialize(
        codec: DcoCodec(
          decodeSuccessData: dco_decode_list_app_notification,
          decodeErrorData: dco_decode_AnyhowException,
        ),
      ),
    );
  ...
  @protected
  ffi.Pointer<wire_cst_wallet_state> cst_encode_box_wallet_state(WalletState raw) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    final ptr = wire.cst_new_box_wallet_state();
    cst_api_fill_to_wire_wallet_state(raw, ptr.ref);
    return ptr;
  }
  ...
  ffi.Pointer<wire_cst_list_app_notification> cst_encode_list_app_notification(List<AppNotification> raw) {
    ...
    for (var i = 0; i < raw.length; ++i) {
      cst_api_fill_to_wire_app_notification(raw[i], ans.ref.ptr[i]);
    }
    return ans;
  }
  ...
  @protected
  ffi.Pointer<wire_cst_list_display_target> cst_encode_list_display_target(List<DisplayTarget> raw) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    final ans = wire.cst_new_list_display_target(raw.length);
    for (var i = 0; i < raw.length; ++i) {
      cst_api_fill_to_wire_display_target(raw[i], ans.ref.ptr[i]);
    }
    return ans;
  }
  ...
  @protected
  ffi.Pointer<wire_cst_list_record_i_32_notification_type> cst_encode_list_record_i_32_notification_type(
    List<(int, NotificationType)> raw,
  ) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    final ans = wire.cst_new_list_record_i_32_notification_type(raw.length);
    for (var i = 0; i < raw.length; ++i) {
      cst_api_fill_to_wire_record_i_32_notification_type(raw[i], ans.ref.ptr[i]);
    }
    return ans;
  }
  ...
  void cst_api_fill_to_wire_attribute_value(AttributeValue apiObj, wire_cst_attribute_value wireObj) {
    ...
    if (apiObj is AttributeValue_Bytes) {
      var pre_value = cst_encode_list_prim_u_8_strict(apiObj.value);
      wireObj.tag = 6;
      wireObj.kind.Bytes.value = pre_value;
      return;
    }
    if (apiObj is AttributeValue_Image) {
      var pre_value = cst_encode_box_autoadd_image(apiObj.value);
      wireObj.tag = 7;
      wireObj.kind.Image.value = pre_value;
      return;
    }
  ...
  @protected
  void cst_api_fill_to_wire_box_wallet_state(WalletState apiObj, ffi.Pointer<wire_cst_wallet_state> wireObj) {
    cst_api_fill_to_wire_wallet_state(apiObj, wireObj.ref);
  }
  ...
  void cst_api_fill_to_wire_display_target(DisplayTarget apiObj, wire_cst_display_target wireObj) {
    ...
    if (apiObj is DisplayTarget_Dashboard) {
      wireObj.tag = 1;
      return;
    }
  }
  ...
  @protected
  void cst_api_fill_to_wire_notification_type(NotificationType apiObj, wire_cst_notification_type wireObj) {
    if (apiObj is NotificationType_CardExpired) {
      var pre_card = cst_encode_box_autoadd_attestation_presentation(apiObj.card);
      wireObj.tag = 0;
      wireObj.kind.CardExpired.card = pre_card;
      return;
    }
    if (apiObj is NotificationType_CardExpiresSoon) {
      var pre_card = cst_encode_box_autoadd_attestation_presentation(apiObj.card);
      var pre_expires_at = cst_encode_String(apiObj.expiresAt);
      wireObj.tag = 1;
      wireObj.kind.CardExpiresSoon.card = pre_card;
      wireObj.kind.CardExpiresSoon.expires_at = pre_expires_at;
      return;
    }
    if (apiObj is NotificationType_Revoked) {
      var pre_card = cst_encode_box_autoadd_attestation_presentation(apiObj.card);
      wireObj.tag = 2;
  ...
  @protected
  void cst_api_fill_to_wire_record_i_32_notification_type(
    (int, NotificationType) apiObj,
    wire_cst_record_i_32_notification_type wireObj,
  ) {
  ...
  @protected
  void sse_encode_StreamSink_list_app_notification_Dco(
    RustStreamSink<List<AppNotification>> self,
    SseSerializer serializer,
  );
  ...
  @protected
  void sse_encode_app_notification(AppNotification self, SseSerializer serializer);
  ...
  @protected
  void sse_encode_list_display_target(List<DisplayTarget> self, SseSerializer serializer);
...
class WalletCoreWire implements BaseWire {
  ...
  WireSyncRust2DartDco wire__crate__models__image__SanitizedSvg_xml(int that) {
    return _wire__crate__models__image__SanitizedSvg_xml(that);
  }
  ...
  void wire__crate__api__full__accept_issuance(
    ...
    return _wire__crate__api__full__accept_issuance(port_, pin);
  }
  ...
  void wire__crate__api__full__accept_pid_issuance(
    ...
    return _wire__crate__api__full__accept_pid_issuance(port_, pin);
  }
  ...
  void wire__crate__api__full__cancel_disclosure(int port_) {
    return _wire__crate__api__full__cancel_disclosure(port_);
  }
  ...
  void wire__crate__api__full__cancel_issuance(int port_) {
    return _wire__crate__api__full__cancel_issuance(port_);
  }
  ...
  void wire__crate__api__full__cancel_pin_recovery(int port_) {
    return _wire__crate__api__full__cancel_pin_recovery(port_);
  }
  ...
  void wire__crate__api__full__cancel_session(int port_) {
    return _wire__crate__api__full__cancel_session(port_);
  }
  ...
  void wire__crate__api__full__cancel_wallet_transfer(int port_) {
    return _wire__crate__api__full__cancel_wallet_transfer(port_);
  }
  ...
  void wire__crate__api__full__change_pin(
    ...
    return _wire__crate__api__full__change_pin(port_, old_pin, new_pin);
  }
  ...
  void wire__crate__api__full__check_pin(
    ...
    return _wire__crate__api__full__check_pin(port_, pin);
  }
  ...
  void wire__crate__api__full__clear_attestations_stream(int port_) {
    return _wire__crate__api__full__clear_attestations_stream(port_);
  }
  ...
  void wire__crate__api__full__clear_direct_notifications_callback(int port_) {
    return _wire__crate__api__full__clear_direct_notifications_callback(port_);
  }

  late final _wire__crate__api__full__clear_direct_notifications_callbackPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
        'frbgen_wallet_core_wire__crate__api__full__clear_direct_notifications_callback',
      );
  late final _wire__crate__api__full__clear_direct_notifications_callback =
      _wire__crate__api__full__clear_direct_notifications_callbackPtr.asFunction<void Function(int)>();

  void wire__crate__api__full__clear_lock_stream(int port_) {
    return _wire__crate__api__full__clear_lock_stream(port_);
  }
  ...
  void wire__crate__api__full__clear_recent_history_stream(int port_) {
    return _wire__crate__api__full__clear_recent_history_stream(port_);
  }
  ...
  void wire__crate__api__full__clear_scheduled_notifications_stream(int port_) {
    return _wire__crate__api__full__clear_scheduled_notifications_stream(port_);
  }

  late final _wire__crate__api__full__clear_scheduled_notifications_streamPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
        'frbgen_wallet_core_wire__crate__api__full__clear_scheduled_notifications_stream',
      );
  ...
  void wire__crate__api__full__complete_pin_recovery(
    ...
    return _wire__crate__api__full__complete_pin_recovery(port_, pin);
  }
  ...
  void wire__crate__api__full__confirm_wallet_transfer(
    ...
    return _wire__crate__api__full__confirm_wallet_transfer(port_, pin);
  }
  ...
  void wire__crate__api__full__continue_change_pin(
    ...
    return _wire__crate__api__full__continue_change_pin(port_, pin);
  }
  ...
  void wire__crate__api__full__continue_close_proximity_disclosure(int port_) {
    return _wire__crate__api__full__continue_close_proximity_disclosure(port_);
  }
  ...
  void wire__crate__api__full__continue_issuance(
    ...
    return _wire__crate__api__full__continue_issuance(port_, uri);
  }
  ...
  void wire__crate__api__full__continue_pin_recovery(
    ...
    return _wire__crate__api__full__continue_pin_recovery(port_, uri);
  }
  ...
  void wire__crate__api__full__create_pid_issuance_redirect_uri(int port_) {
    return _wire__crate__api__full__create_pid_issuance_redirect_uri(port_);
  }
  ...
  void wire__crate__api__full__create_pid_renewal_redirect_uri(int port_) {
    return _wire__crate__api__full__create_pid_renewal_redirect_uri(port_);
  }
  ...
  void wire__crate__api__full__create_pin_recovery_redirect_uri(int port_) {
    return _wire__crate__api__full__create_pin_recovery_redirect_uri(port_);
  }
  ...
  void wire__crate__api__full__get_history_for_card(
    ...
    return _wire__crate__api__full__get_history_for_card(port_, attestation_id);
  }
  ...
  void wire__crate__api__full__get_registration_revocation_code(int port_) {
    return _wire__crate__api__full__get_registration_revocation_code(port_);
  }
  ...
  void wire__crate__api__full__get_revocation_code(
    ...
    return _wire__crate__api__full__get_revocation_code(port_, pin);
  }
  ...
  void wire__crate__api__full__get_version_string(int port_) {
    return _wire__crate__api__full__get_version_string(port_);
  }
  ...
  void wire__crate__api__full__get_wallet_state(int port_) {
    return _wire__crate__api__full__get_wallet_state(port_);
  }
  ...
  void wire__crate__api__full__get_wallet_transfer_state(int port_) {
    return _wire__crate__api__full__get_wallet_transfer_state(port_);
  }
  ...
  void wire__crate__api__full__has_registration(int port_) {
    return _wire__crate__api__full__has_registration(port_);
  }
  ...
  void wire__crate__api__full__identify_uri(
    ...
    return _wire__crate__api__full__identify_uri(port_, uri);
  }
  ...
  void wire__crate__models__image__image_try_jpeg_from_bytes(
    int port_,
    ffi.Pointer<wire_cst_list_prim_u_8_loose> value,
  ) {
    return _wire__crate__models__image__image_try_jpeg_from_bytes(port_, value);
  }

  late final _wire__crate__models__image__image_try_jpeg_from_bytesPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Void Function(
            ffi.Int64,
        ...
        >
      >(
        'frbgen_wallet_core_wire__crate__models__image__image_try_jpeg_from_bytes',
      );
  late final _wire__crate__models__image__image_try_jpeg_from_bytes =
      _wire__crate__models__image__image_try_jpeg_from_bytesPtr
          .asFunction<void Function(int, ffi.Pointer<wire_cst_list_prim_u_8_loose>)>();

  void wire__crate__api__full__init(int port_) {
    return _wire__crate__api__full__init(port_);
  }
  ...
  void wire__crate__api__full__init_wallet_transfer(int port_) {
    return _wire__crate__api__full__init_wallet_transfer(port_);
  }
  ...
  void wire__crate__api__full__is_biometric_unlock_enabled(int port_) {
    return _wire__crate__api__full__is_biometric_unlock_enabled(port_);
  }
  ...
  void wire__crate__api__full__is_initialized(int port_) {
    return _wire__crate__api__full__is_initialized(port_);
  }
  ...
  void wire__crate__api__full__is_valid_pin(
    ...
    return _wire__crate__api__full__is_valid_pin(port_, pin);
  }
  ...
  void wire__crate__api__full__lock_wallet(int port_) {
    return _wire__crate__api__full__lock_wallet(port_);
  }
  ...
  void wire__crate__api__full__pair_wallet_transfer(
    ...
    return _wire__crate__api__full__pair_wallet_transfer(port_, uri);
  }
  ...
  void wire__crate__api__full__perform_background_sync(int port_) {
    return _wire__crate__api__full__perform_background_sync(port_);
  }

  late final _wire__crate__api__full__perform_background_syncPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
        'frbgen_wallet_core_wire__crate__api__full__perform_background_sync',
      );
  late final _wire__crate__api__full__perform_background_sync = _wire__crate__api__full__perform_background_syncPtr
      .asFunction<void Function(int)>();

  void wire__crate__api__full__receive_wallet_transfer(int port_) {
    return _wire__crate__api__full__receive_wallet_transfer(port_);
  }
  ...
  void wire__crate__api__full__register(
    ...
    return _wire__crate__api__full__register(port_, pin);
  }
  ...
  void wire__crate__api__full__reset_wallet(int port_) {
    return _wire__crate__api__full__reset_wallet(port_);
  }
  ...
  void wire__crate__api__full__set_attestations_stream(
    ...
    return _wire__crate__api__full__set_attestations_stream(port_, sink);
  }
  ...
  void wire__crate__api__full__set_biometric_unlock(int port_, bool enable) {
    return _wire__crate__api__full__set_biometric_unlock(port_, enable);
  }
  ...
  void wire__crate__api__full__set_configuration_stream(
    ...
    return _wire__crate__api__full__set_configuration_stream(port_, sink);
  }
  ...
  late final _wire__crate__api__full__set_direct_notifications_callbackPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, ffi.Pointer<ffi.Void>)>>(
        'frbgen_wallet_core_wire__crate__api__full__set_direct_notifications_callback',
      );
  late final _wire__crate__api__full__set_direct_notifications_callback =
      _wire__crate__api__full__set_direct_notifications_callbackPtr
  ...
  void wire__crate__api__full__set_lock_stream(
    ...
    return _wire__crate__api__full__set_lock_stream(port_, sink);
  }
  ...
  void wire__crate__api__full__set_recent_history_stream(
    ...
    return _wire__crate__api__full__set_recent_history_stream(port_, sink);
  }
  ...
  void wire__crate__api__full__set_scheduled_notifications_stream(
    int port_,
    ffi.Pointer<wire_cst_list_prim_u_8_strict> sink,
  ) {
    return _wire__crate__api__full__set_scheduled_notifications_stream(
      port_,
      sink,
    );
  }

  late final _wire__crate__api__full__set_scheduled_notifications_streamPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Void Function(
            ffi.Int64,
        ...
        >
      >(
        'frbgen_wallet_core_wire__crate__api__full__set_scheduled_notifications_stream',
      );
  ...
  void wire__crate__api__full__set_version_state_stream(
    ...
    return _wire__crate__api__full__set_version_state_stream(port_, sink);
  }
  ...
  void wire__crate__api__full__skip_wallet_transfer(int port_) {
    return _wire__crate__api__full__skip_wallet_transfer(port_);
  }
  ...
  void wire__crate__api__full__start_disclosure(
    ...
    return _wire__crate__api__full__start_disclosure(port_, uri, is_qr_code);
  }
  ...
  void wire__crate__api__full__start_issuance_from_offer(
    ...
    return _wire__crate__api__full__start_issuance_from_offer(port_, offer_uri);
  }
  ...
  void wire__crate__api__full__transfer_wallet(int port_) {
    return _wire__crate__api__full__transfer_wallet(port_);
  }
  ...
  void wire__crate__api__full__unlock_wallet(
    ...
    return _wire__crate__api__full__unlock_wallet(port_, pin);
  }
  ...
  void wire__crate__api__full__unlock_wallet_with_biometrics(int port_) {
    return _wire__crate__api__full__unlock_wallet_with_biometrics(port_);
  }
  ...
  ffi.Pointer<ffi.Int32> cst_new_box_autoadd_revocation_status(int value) {
    return _cst_new_box_autoadd_revocation_status(value);
  }
  ...
  ffi.Pointer<wire_cst_wallet_state> cst_new_box_wallet_state() {
    return _cst_new_box_wallet_state();
  }

  late final _cst_new_box_wallet_statePtr = _lookup<ffi.NativeFunction<ffi.Pointer<wire_cst_wallet_state> Function()>>(
    'frbgen_wallet_core_cst_new_box_wallet_state',
  );
  ...
  ffi.Pointer<wire_cst_list_app_notification> cst_new_list_app_notification(
    ...
    return _cst_new_list_app_notification(len);
  }

  late final _cst_new_list_app_notificationPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<wire_cst_list_app_notification> Function(ffi.Int32)>>(
        'frbgen_wallet_core_cst_new_list_app_notification',
      );
  late final _cst_new_list_app_notification = _cst_new_list_app_notificationPtr
      .asFunction<ffi.Pointer<wire_cst_list_app_notification> Function(int)>();

  ffi.Pointer<wire_cst_list_attestation_attribute> cst_new_list_attestation_attribute(int len) {
    return _cst_new_list_attestation_attribute(len);
  }
  ...
  ffi.Pointer<wire_cst_list_attestation_presentation> cst_new_list_attestation_presentation(int len) {
    return _cst_new_list_attestation_presentation(len);
  }

  late final _cst_new_list_attestation_presentationPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Pointer<wire_cst_list_attestation_presentation> Function(
            ffi.Int32,
          )
        >
  ...
  ffi.Pointer<wire_cst_list_attribute_value> cst_new_list_attribute_value(
    ...
    return _cst_new_list_attribute_value(len);
  }
  ...
  ffi.Pointer<wire_cst_list_disclosure_options> cst_new_list_disclosure_options(
    ...
    return _cst_new_list_disclosure_options(len);
  }
  ...
  ffi.Pointer<wire_cst_list_display_metadata> cst_new_list_display_metadata(
    ...
    return _cst_new_list_display_metadata(len);
  }
  ...
  ffi.Pointer<wire_cst_list_display_target> cst_new_list_display_target(
    int len,
  ) {
    return _cst_new_list_display_target(len);
  }

  late final _cst_new_list_display_targetPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<wire_cst_list_display_target> Function(ffi.Int32)>>(
        'frbgen_wallet_core_cst_new_list_display_target',
      );
  late final _cst_new_list_display_target = _cst_new_list_display_targetPtr
      .asFunction<ffi.Pointer<wire_cst_list_display_target> Function(int)>();

  ffi.Pointer<wire_cst_list_localized_string> cst_new_list_localized_string(
    int len,
  ) {
    return _cst_new_list_localized_string(len);
  }
  ...
  ffi.Pointer<wire_cst_list_missing_attribute> cst_new_list_missing_attribute(
    ...
    return _cst_new_list_missing_attribute(len);
  }
  ...
  ffi.Pointer<wire_cst_list_pid_attestation> cst_new_list_pid_attestation(
    ...
    return _cst_new_list_pid_attestation(len);
  }
  ...
  late final _cst_new_list_prim_u_8_loosePtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<wire_cst_list_prim_u_8_loose> Function(ffi.Int32)>>(
        'frbgen_wallet_core_cst_new_list_prim_u_8_loose',
      );
  ...
  ffi.Pointer<wire_cst_list_record_i_32_notification_type> cst_new_list_record_i_32_notification_type(int len) {
    return _cst_new_list_record_i_32_notification_type(len);
  }

  late final _cst_new_list_record_i_32_notification_typePtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Pointer<wire_cst_list_record_i_32_notification_type> Function(
            ffi.Int32,
          )
        >
      >('frbgen_wallet_core_cst_new_list_record_i_32_notification_type');
  late final _cst_new_list_record_i_32_notification_type = _cst_new_list_record_i_32_notification_typePtr
      .asFunction<
        ffi.Pointer<wire_cst_list_record_i_32_notification_type> Function(
          int,
        )
...
final class wire_cst_WalletState_Locked extends ffi.Struct {
...
final class wire_cst_NotificationType_CardExpiresSoon extends ffi.Struct {
  external ffi.Pointer<wire_cst_attestation_presentation> card;

  external ffi.Pointer<wire_cst_list_prim_u_8_strict> expires_at;
}

final class wire_cst_NotificationType_Revoked extends ffi.Struct {
  external ffi.Pointer<wire_cst_attestation_presentation> card;
}

final class NotificationTypeKind extends ffi.Union {
  external wire_cst_NotificationType_CardExpired CardExpired;

  external wire_cst_NotificationType_CardExpiresSoon CardExpiresSoon;

  external wire_cst_NotificationType_Revoked Revoked;
}

final class wire_cst_notification_type extends ffi.Struct {
  @ffi.Int32()
  external int tag;

  external NotificationTypeKind kind;
}
...
final class DisplayTargetKind extends ffi.Union {
  external wire_cst_DisplayTarget_Os Os;
}

final class wire_cst_display_target extends ffi.Struct {
  @ffi.Int32()
  external int tag;

  external DisplayTargetKind kind;
}

final class wire_cst_list_display_target extends ffi.Struct {
  external ffi.Pointer<wire_cst_display_target> ptr;
...
final class wire_cst_app_notification extends ffi.Struct {
  ...
  external ffi.Pointer<wire_cst_list_display_target> targets;
}

final class wire_cst_list_app_notification extends ffi.Struct {
  external ffi.Pointer<wire_cst_app_notification> ptr;
...
final class wire_cst_record_i_32_notification_type extends ffi.Struct {
  @ffi.Int32()
  external int field0;

  external wire_cst_notification_type field1;
}

final class wire_cst_list_record_i_32_notification_type extends ffi.Struct {
  external ffi.Pointer<wire_cst_record_i_32_notification_type> ptr;
