...
Stream<List<Card>> setCardsStream() => WalletCore.instance.api.crateApiFullSetCardsStream();

Future<void> clearCardsStream() => WalletCore.instance.api.crateApiFullClearCardsStream();
...
Future<List<Card>> continuePidIssuance({required String uri}) =>
