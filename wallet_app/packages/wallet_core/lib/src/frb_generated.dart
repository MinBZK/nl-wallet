...
class WalletCoreApiImpl extends WalletCoreApiImplPlatform implements WalletCoreApi {
  ...
  Future<void> crateApiFullPairWalletTransfer({required String uri}) {
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          var arg0 = cst_encode_String(uri);
          return wire.wire__crate__api__full__pair_wallet_transfer(port_, arg0);
        },
        codec: DcoCodec(
          decodeSuccessData: dco_decode_unit,
          decodeErrorData: dco_decode_AnyhowException,
        ),
        constMeta: kCrateApiFullPairWalletTransferConstMeta,
        argValues: [uri],
        apiImpl: this,
      ),
    );
  ...
  AppNotification dco_decode_app_notification(dynamic raw) {
    ...
    return AppNotification(
      ...
      typ: dco_decode_notification_type(arr[1]),
      targets: dco_decode_list_display_target(arr[2]),
    );
  }
    ...
    switch (raw[0]) {
      ...
      case 8:
        return AttributeValue_Map(
          value: dco_decode_list_record_string_attribute_value(raw[1]),
        );
      default:
        throw Exception("unreachable");
    }
  ...
  AttestationPresentation dco_decode_box_autoadd_attestation_presentation(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_attestation_presentation(raw);
  }
  ...
  ImageWithMetadata dco_decode_box_autoadd_image_with_metadata(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_image_with_metadata(raw);
  }
  ...
  DisclosureOptions dco_decode_disclosure_options(dynamic raw) {
    ...
    return DisclosureOptions(
      field0: dco_decode_list_attestation_presentation(arr[0]),
    );
  }
  ...
  List<AttestationPresentation> dco_decode_list_attestation_presentation(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_attestation_presentation).toList();
  }

  @protected
  List<AttributeValue> dco_decode_list_attribute_value(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_attribute_value).toList();
  }
  ...
  List<DisclosureOptions> dco_decode_list_disclosure_options(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_disclosure_options).toList();
  }
  ...
  List<DisplayTarget> dco_decode_list_display_target(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_display_target).toList();
  }
  ...
  List<(String, AttributeValue)> dco_decode_list_record_string_attribute_value(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_record_string_attribute_value).toList();
  }
  ...
  NotificationType dco_decode_notification_type(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return NotificationType_CardExpired(
  ...
  PidIssuanceResult dco_decode_pid_issuance_result(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return PidIssuanceResult_Ok(
          transferAvailable: dco_decode_bool(raw[1]),
        );
      case 1:
        return PidIssuanceResult_InstructionError(
          error: dco_decode_box_autoadd_wallet_instruction_error(raw[1]),
        );
      default:
        throw Exception("unreachable");
  ...
  (String, AttributeValue) dco_decode_record_string_attribute_value(dynamic raw) {
    ...
    return (
      ...
      dco_decode_attribute_value(arr[1]),
    );
  }
    ...
    switch (raw[0]) {
      case 0:
        return StartDisclosureResult_Request(
          ...
          disclosureOptions: dco_decode_list_disclosure_options(raw[3]),
  ...
  AppNotification sse_decode_app_notification(SseDeserializer deserializer) {
    ...
    var var_typ = sse_decode_notification_type(deserializer);
    var var_targets = sse_decode_list_display_target(deserializer);
    return AppNotification(id: var_id, typ: var_typ, targets: var_targets);
  }
  ...
  AttributeValue sse_decode_attribute_value(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      ...
      case 8:
        var var_value = sse_decode_list_record_string_attribute_value(deserializer);
  ...
  AttestationPresentation sse_decode_box_autoadd_attestation_presentation(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_attestation_presentation(deserializer));
  }
  ...
  ImageWithMetadata sse_decode_box_autoadd_image_with_metadata(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_image_with_metadata(deserializer));
  }
  ...
  DisclosureOptions sse_decode_disclosure_options(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_field0 = sse_decode_list_attestation_presentation(deserializer);
    return DisclosureOptions(field0: var_field0);
  }
  ...
  List<AppNotification> sse_decode_list_app_notification(SseDeserializer deserializer) {
    ...
    var ans_ = <AppNotification>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_app_notification(deserializer));
    }
    return ans_;
  }
  ...
  List<AttestationPresentation> sse_decode_list_attestation_presentation(SseDeserializer deserializer) {
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <AttestationPresentation>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_attestation_presentation(deserializer));
    }
    return ans_;
  }
  ...
  List<AttributeValue> sse_decode_list_attribute_value(SseDeserializer deserializer) {
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <AttributeValue>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_attribute_value(deserializer));
    }
    return ans_;
  }
  ...
  List<DisclosureOptions> sse_decode_list_disclosure_options(SseDeserializer deserializer) {
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <DisclosureOptions>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_disclosure_options(deserializer));
    }
    return ans_;
  }
  ...
  List<DisplayTarget> sse_decode_list_display_target(SseDeserializer deserializer) {
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <DisplayTarget>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_display_target(deserializer));
    }
    return ans_;
  }
  ...
  List<(String, AttributeValue)> sse_decode_list_record_string_attribute_value(SseDeserializer deserializer) {
    ...
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_record_string_attribute_value(deserializer));
    }
    return ans_;
  }
  ...
  NotificationType sse_decode_notification_type(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      case 0:
        ...
        return NotificationType_CardExpired(card: var_card);
      case 1:
        var var_card = sse_decode_box_autoadd_attestation_presentation(deserializer);
  ...
  List<AttestationPresentation>? sse_decode_opt_list_attestation_presentation(SseDeserializer deserializer) {
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_list_attestation_presentation(deserializer));
    } else {
      return null;
    }
  }
  ...
  PidIssuanceResult sse_decode_pid_issuance_result(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      case 0:
        var var_transferAvailable = sse_decode_bool(deserializer);
        return PidIssuanceResult_Ok(transferAvailable: var_transferAvailable);
      case 1:
        var var_error = sse_decode_box_autoadd_wallet_instruction_error(deserializer);
        return PidIssuanceResult_InstructionError(error: var_error);
      default:
        throw UnimplementedError('');
    }
  }
  ...
  (String, AttributeValue) sse_decode_record_string_attribute_value(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_field0 = sse_decode_String(deserializer);
    var var_field1 = sse_decode_attribute_value(deserializer);
    return (var_field0, var_field1);
  }
  ...
  StartDisclosureResult sse_decode_start_disclosure_result(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      case 0:
        ...
        var var_disclosureOptions = sse_decode_list_disclosure_options(deserializer);
        ...
        return StartDisclosureResult_Request(
          ...
          policy: var_policy,
          disclosureOptions: var_disclosureOptions,
  ...
  WalletEvent sse_decode_wallet_event(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      case 0:
        ...
        var var_sharedAttestations = sse_decode_opt_list_attestation_presentation(deserializer);
  ...
  void sse_encode_app_notification(AppNotification self, SseSerializer serializer) {
    ...
    sse_encode_notification_type(self.typ, serializer);
    sse_encode_list_display_target(self.targets, serializer);
  }
  ...
  void sse_encode_attribute_value(AttributeValue self, SseSerializer serializer) {
    ...
    switch (self) {
      ...
      case AttributeValue_Map(value: final value):
        ...
        sse_encode_list_record_string_attribute_value(value, serializer);
    }
  }
  ...
  void sse_encode_box_autoadd_attestation_presentation(AttestationPresentation self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_attestation_presentation(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_image_with_metadata(ImageWithMetadata self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_image_with_metadata(self, serializer);
  }
  ...
  void sse_encode_disclosure_options(DisclosureOptions self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_list_attestation_presentation(self.field0, serializer);
  }
  ...
  void sse_encode_list_app_notification(List<AppNotification> self, SseSerializer serializer) {
    ...
    for (final item in self) {
      sse_encode_app_notification(item, serializer);
    }
  }
  ...
  void sse_encode_list_attestation_presentation(List<AttestationPresentation> self, SseSerializer serializer) {
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_attestation_presentation(item, serializer);
    }
  }
  ...
  void sse_encode_list_attribute_value(List<AttributeValue> self, SseSerializer serializer) {
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_attribute_value(item, serializer);
    }
  }
  ...
  void sse_encode_list_disclosure_options(List<DisclosureOptions> self, SseSerializer serializer) {
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_disclosure_options(item, serializer);
    }
  }
  ...
  void sse_encode_list_display_target(List<DisplayTarget> self, SseSerializer serializer) {
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_display_target(item, serializer);
    }
  }
  ...
  void sse_encode_list_record_string_attribute_value(List<(String, AttributeValue)> self, SseSerializer serializer) {
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_record_string_attribute_value(item, serializer);
    }
  }
  ...
  void sse_encode_notification_type(NotificationType self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case NotificationType_CardExpired(card: final card):
        sse_encode_i_32(0, serializer);
        sse_encode_box_autoadd_attestation_presentation(card, serializer);
      case NotificationType_CardExpiresSoon(card: final card, expiresAt: final expiresAt):
        sse_encode_i_32(1, serializer);
        sse_encode_box_autoadd_attestation_presentation(card, serializer);
  ...
  void sse_encode_opt_list_attestation_presentation(List<AttestationPresentation>? self, SseSerializer serializer) {
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_list_attestation_presentation(self, serializer);
    }
  }
  ...
  void sse_encode_pid_issuance_result(PidIssuanceResult self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case PidIssuanceResult_Ok(transferAvailable: final transferAvailable):
        sse_encode_i_32(0, serializer);
        sse_encode_bool(transferAvailable, serializer);
      case PidIssuanceResult_InstructionError(error: final error):
        sse_encode_i_32(1, serializer);
        sse_encode_box_autoadd_wallet_instruction_error(error, serializer);
    }
  }
  ...
  void sse_encode_record_string_attribute_value((String, AttributeValue) self, SseSerializer serializer) {
    ...
    sse_encode_attribute_value(self.$2, serializer);
  }
  ...
  void sse_encode_start_disclosure_result(StartDisclosureResult self, SseSerializer serializer) {
    ...
    switch (self) {
      case StartDisclosureResult_Request(
        ...
        policy: final policy,
        disclosureOptions: final disclosureOptions,
        ...
        sse_encode_list_disclosure_options(disclosureOptions, serializer);
  ...
  void sse_encode_wallet_event(WalletEvent self, SseSerializer serializer) {
    ...
    switch (self) {
      case WalletEvent_Disclosure(
        ...
        sse_encode_opt_list_attestation_presentation(sharedAttestations, serializer);
