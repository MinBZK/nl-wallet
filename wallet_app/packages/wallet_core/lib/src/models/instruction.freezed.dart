...
$DisclosureBasedIssuanceResultCopyWith(DisclosureBasedIssuanceResult _, $Res Function(DisclosureBasedIssuanceResult) __);
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( DisclosureBasedIssuanceResult_Ok value)?  ok,TResult Function( DisclosureBasedIssuanceResult_InstructionError value)?  instructionError,required TResult orElse(),}){
final _that = this;
switch (_that) {
case DisclosureBasedIssuanceResult_Ok() when ok != null:
return ok(_that);case DisclosureBasedIssuanceResult_InstructionError() when instructionError != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( DisclosureBasedIssuanceResult_Ok value)  ok,required TResult Function( DisclosureBasedIssuanceResult_InstructionError value)  instructionError,}){
final _that = this;
switch (_that) {
case DisclosureBasedIssuanceResult_Ok():
return ok(_that);case DisclosureBasedIssuanceResult_InstructionError():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( DisclosureBasedIssuanceResult_Ok value)?  ok,TResult? Function( DisclosureBasedIssuanceResult_InstructionError value)?  instructionError,}){
final _that = this;
switch (_that) {
case DisclosureBasedIssuanceResult_Ok() when ok != null:
return ok(_that);case DisclosureBasedIssuanceResult_InstructionError() when instructionError != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( List<AttestationPresentation> field0)?  ok,TResult Function( WalletInstructionError error)?  instructionError,required TResult orElse(),}) {final _that = this;
switch (_that) {
case DisclosureBasedIssuanceResult_Ok() when ok != null:
return ok(_that.field0);case DisclosureBasedIssuanceResult_InstructionError() when instructionError != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( List<AttestationPresentation> field0)  ok,required TResult Function( WalletInstructionError error)  instructionError,}) {final _that = this;
switch (_that) {
case DisclosureBasedIssuanceResult_Ok():
return ok(_that.field0);case DisclosureBasedIssuanceResult_InstructionError():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( List<AttestationPresentation> field0)?  ok,TResult? Function( WalletInstructionError error)?  instructionError,}) {final _that = this;
switch (_that) {
case DisclosureBasedIssuanceResult_Ok() when ok != null:
return ok(_that.field0);case DisclosureBasedIssuanceResult_InstructionError() when instructionError != null:
return instructionError(_that.error);case _:
...
$DisclosureBasedIssuanceResult_OkCopyWith<DisclosureBasedIssuanceResult_Ok> get copyWith => _$DisclosureBasedIssuanceResult_OkCopyWithImpl<DisclosureBasedIssuanceResult_Ok>(this, _$identity);
...
/// @nodoc
abstract mixin class $DisclosureBasedIssuanceResult_OkCopyWith<$Res> implements $DisclosureBasedIssuanceResultCopyWith<$Res> {
  factory $DisclosureBasedIssuanceResult_OkCopyWith(DisclosureBasedIssuanceResult_Ok value, $Res Function(DisclosureBasedIssuanceResult_Ok) _then) = _$DisclosureBasedIssuanceResult_OkCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$DisclosureBasedIssuanceResult_OkCopyWithImpl<$Res>
    implements $DisclosureBasedIssuanceResult_OkCopyWith<$Res> {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$DisclosureBasedIssuanceResult_InstructionErrorCopyWith<DisclosureBasedIssuanceResult_InstructionError> get copyWith => _$DisclosureBasedIssuanceResult_InstructionErrorCopyWithImpl<DisclosureBasedIssuanceResult_InstructionError>(this, _$identity);
...
/// @nodoc
abstract mixin class $DisclosureBasedIssuanceResult_InstructionErrorCopyWith<$Res> implements $DisclosureBasedIssuanceResultCopyWith<$Res> {
  factory $DisclosureBasedIssuanceResult_InstructionErrorCopyWith(DisclosureBasedIssuanceResult_InstructionError value, $Res Function(DisclosureBasedIssuanceResult_InstructionError) _then) = _$DisclosureBasedIssuanceResult_InstructionErrorCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( PidIssuanceResult_Ok value)?  ok,TResult Function( PidIssuanceResult_InstructionError value)?  instructionError,required TResult orElse(),}){
final _that = this;
switch (_that) {
case PidIssuanceResult_Ok() when ok != null:
return ok(_that);case PidIssuanceResult_InstructionError() when instructionError != null:
return instructionError(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( PidIssuanceResult_Ok value)  ok,required TResult Function( PidIssuanceResult_InstructionError value)  instructionError,}){
final _that = this;
switch (_that) {
case PidIssuanceResult_Ok():
return ok(_that);case PidIssuanceResult_InstructionError():
return instructionError(_that);}
}
/// A variant of `map` that fallback to returning `null`.
///
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( PidIssuanceResult_Ok value)?  ok,TResult? Function( PidIssuanceResult_InstructionError value)?  instructionError,}){
final _that = this;
switch (_that) {
case PidIssuanceResult_Ok() when ok != null:
return ok(_that);case PidIssuanceResult_InstructionError() when instructionError != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( bool transferAvailable)?  ok,TResult Function( WalletInstructionError error)?  instructionError,required TResult orElse(),}) {final _that = this;
switch (_that) {
case PidIssuanceResult_Ok() when ok != null:
return ok(_that.transferAvailable);case PidIssuanceResult_InstructionError() when instructionError != null:
return instructionError(_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( bool transferAvailable)  ok,required TResult Function( WalletInstructionError error)  instructionError,}) {final _that = this;
switch (_that) {
case PidIssuanceResult_Ok():
return ok(_that.transferAvailable);case PidIssuanceResult_InstructionError():
return instructionError(_that.error);}
}
/// A variant of `when` that fallback to returning `null`
///
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( bool transferAvailable)?  ok,TResult? Function( WalletInstructionError error)?  instructionError,}) {final _that = this;
switch (_that) {
case PidIssuanceResult_Ok() when ok != null:
return ok(_that.transferAvailable);case PidIssuanceResult_InstructionError() when instructionError != null:
return instructionError(_that.error);case _:
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$PidIssuanceResult_OkCopyWith<PidIssuanceResult_Ok> get copyWith => _$PidIssuanceResult_OkCopyWithImpl<PidIssuanceResult_Ok>(this, _$identity);
...
abstract mixin class $PidIssuanceResult_OkCopyWith<$Res> implements $PidIssuanceResultCopyWith<$Res> {
  factory $PidIssuanceResult_OkCopyWith(PidIssuanceResult_Ok value, $Res Function(PidIssuanceResult_Ok) _then) = _$PidIssuanceResult_OkCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$PidIssuanceResult_OkCopyWithImpl<$Res>
    implements $PidIssuanceResult_OkCopyWith<$Res> {
...
/// Create a copy of PidIssuanceResult
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? transferAvailable = null,}) {
  return _then(PidIssuanceResult_Ok(
transferAvailable: null == transferAvailable ? _self.transferAvailable : transferAvailable // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$PidIssuanceResult_InstructionErrorCopyWith<PidIssuanceResult_InstructionError> get copyWith => _$PidIssuanceResult_InstructionErrorCopyWithImpl<PidIssuanceResult_InstructionError>(this, _$identity);
...
abstract mixin class $PidIssuanceResult_InstructionErrorCopyWith<$Res> implements $PidIssuanceResultCopyWith<$Res> {
  factory $PidIssuanceResult_InstructionErrorCopyWith(PidIssuanceResult_InstructionError value, $Res Function(PidIssuanceResult_InstructionError) _then) = _$PidIssuanceResult_InstructionErrorCopyWithImpl;
@useResult
$Res call({
 WalletInstructionError error
});
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( WalletInstructionError_IncorrectPin value)?  incorrectPin,TResult Function( WalletInstructionError_Timeout value)?  timeout,TResult Function( WalletInstructionError_Blocked value)?  blocked,required TResult orElse(),}){
final _that = this;
switch (_that) {
case WalletInstructionError_IncorrectPin() when incorrectPin != null:
return incorrectPin(_that);case WalletInstructionError_Timeout() when timeout != null:
return timeout(_that);case WalletInstructionError_Blocked() when blocked != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( WalletInstructionError_IncorrectPin value)  incorrectPin,required TResult Function( WalletInstructionError_Timeout value)  timeout,required TResult Function( WalletInstructionError_Blocked value)  blocked,}){
final _that = this;
switch (_that) {
case WalletInstructionError_IncorrectPin():
return incorrectPin(_that);case WalletInstructionError_Timeout():
return timeout(_that);case WalletInstructionError_Blocked():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( WalletInstructionError_IncorrectPin value)?  incorrectPin,TResult? Function( WalletInstructionError_Timeout value)?  timeout,TResult? Function( WalletInstructionError_Blocked value)?  blocked,}){
final _that = this;
switch (_that) {
case WalletInstructionError_IncorrectPin() when incorrectPin != null:
return incorrectPin(_that);case WalletInstructionError_Timeout() when timeout != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( int attemptsLeftInRound,  bool isFinalRound)?  incorrectPin,TResult Function( BigInt timeoutMillis)?  timeout,TResult Function()?  blocked,required TResult orElse(),}) {final _that = this;
switch (_that) {
case WalletInstructionError_IncorrectPin() when incorrectPin != null:
return incorrectPin(_that.attemptsLeftInRound,_that.isFinalRound);case WalletInstructionError_Timeout() when timeout != null:
return timeout(_that.timeoutMillis);case WalletInstructionError_Blocked() when blocked != null:
return blocked();case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( int attemptsLeftInRound,  bool isFinalRound)  incorrectPin,required TResult Function( BigInt timeoutMillis)  timeout,required TResult Function()  blocked,}) {final _that = this;
switch (_that) {
case WalletInstructionError_IncorrectPin():
return incorrectPin(_that.attemptsLeftInRound,_that.isFinalRound);case WalletInstructionError_Timeout():
return timeout(_that.timeoutMillis);case WalletInstructionError_Blocked():
return blocked();}
}
/// A variant of `when` that fallback to returning `null`
///
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( int attemptsLeftInRound,  bool isFinalRound)?  incorrectPin,TResult? Function( BigInt timeoutMillis)?  timeout,TResult? Function()?  blocked,}) {final _that = this;
switch (_that) {
case WalletInstructionError_IncorrectPin() when incorrectPin != null:
return incorrectPin(_that.attemptsLeftInRound,_that.isFinalRound);case WalletInstructionError_Timeout() when timeout != null:
return timeout(_that.timeoutMillis);case WalletInstructionError_Blocked() when blocked != null:
...
class WalletInstructionError_IncorrectPin extends WalletInstructionError {
  const WalletInstructionError_IncorrectPin({required this.attemptsLeftInRound, required this.isFinalRound}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$WalletInstructionError_IncorrectPinCopyWith<WalletInstructionError_IncorrectPin> get copyWith => _$WalletInstructionError_IncorrectPinCopyWithImpl<WalletInstructionError_IncorrectPin>(this, _$identity);
...
/// @nodoc
abstract mixin class $WalletInstructionError_IncorrectPinCopyWith<$Res> implements $WalletInstructionErrorCopyWith<$Res> {
  factory $WalletInstructionError_IncorrectPinCopyWith(WalletInstructionError_IncorrectPin value, $Res Function(WalletInstructionError_IncorrectPin) _then) = _$WalletInstructionError_IncorrectPinCopyWithImpl;
@useResult
$Res call({
 int attemptsLeftInRound, bool isFinalRound
});
...
/// Create a copy of WalletInstructionError
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? attemptsLeftInRound = null,Object? isFinalRound = null,}) {
  return _then(WalletInstructionError_IncorrectPin(
attemptsLeftInRound: null == attemptsLeftInRound ? _self.attemptsLeftInRound : attemptsLeftInRound // ignore: cast_nullable_to_non_nullable
as int,isFinalRound: null == isFinalRound ? _self.isFinalRound : isFinalRound // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$WalletInstructionError_TimeoutCopyWith<WalletInstructionError_Timeout> get copyWith => _$WalletInstructionError_TimeoutCopyWithImpl<WalletInstructionError_Timeout>(this, _$identity);
...
abstract mixin class $WalletInstructionError_TimeoutCopyWith<$Res> implements $WalletInstructionErrorCopyWith<$Res> {
  factory $WalletInstructionError_TimeoutCopyWith(WalletInstructionError_Timeout value, $Res Function(WalletInstructionError_Timeout) _then) = _$WalletInstructionError_TimeoutCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$WalletInstructionError_TimeoutCopyWithImpl<$Res>
    implements $WalletInstructionError_TimeoutCopyWith<$Res> {
...
/// Create a copy of WalletInstructionError
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? timeoutMillis = null,}) {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( WalletInstructionResult_Ok value)?  ok,TResult Function( WalletInstructionResult_InstructionError value)?  instructionError,required TResult orElse(),}){
final _that = this;
switch (_that) {
case WalletInstructionResult_Ok() when ok != null:
return ok(_that);case WalletInstructionResult_InstructionError() when instructionError != null:
return instructionError(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( WalletInstructionResult_Ok value)  ok,required TResult Function( WalletInstructionResult_InstructionError value)  instructionError,}){
final _that = this;
switch (_that) {
case WalletInstructionResult_Ok():
return ok(_that);case WalletInstructionResult_InstructionError():
return instructionError(_that);}
}
/// A variant of `map` that fallback to returning `null`.
///
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( WalletInstructionResult_Ok value)?  ok,TResult? Function( WalletInstructionResult_InstructionError value)?  instructionError,}){
final _that = this;
switch (_that) {
case WalletInstructionResult_Ok() when ok != null:
return ok(_that);case WalletInstructionResult_InstructionError() when instructionError != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  ok,TResult Function( WalletInstructionError error)?  instructionError,required TResult orElse(),}) {final _that = this;
switch (_that) {
case WalletInstructionResult_Ok() when ok != null:
return ok();case WalletInstructionResult_InstructionError() when instructionError != null:
return instructionError(_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  ok,required TResult Function( WalletInstructionError error)  instructionError,}) {final _that = this;
switch (_that) {
case WalletInstructionResult_Ok():
return ok();case WalletInstructionResult_InstructionError():
return instructionError(_that.error);}
}
/// A variant of `when` that fallback to returning `null`
///
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  ok,TResult? Function( WalletInstructionError error)?  instructionError,}) {final _that = this;
switch (_that) {
case WalletInstructionResult_Ok() when ok != null:
return ok();case WalletInstructionResult_InstructionError() when instructionError != null:
return instructionError(_that.error);case _:
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$WalletInstructionResult_InstructionErrorCopyWith<WalletInstructionResult_InstructionError> get copyWith => _$WalletInstructionResult_InstructionErrorCopyWithImpl<WalletInstructionResult_InstructionError>(this, _$identity);
...
/// @nodoc
abstract mixin class $WalletInstructionResult_InstructionErrorCopyWith<$Res> implements $WalletInstructionResultCopyWith<$Res> {
  factory $WalletInstructionResult_InstructionErrorCopyWith(WalletInstructionResult_InstructionError value, $Res Function(WalletInstructionResult_InstructionError) _then) = _$WalletInstructionResult_InstructionErrorCopyWithImpl;
@useResult
$Res call({
 WalletInstructionError error
});
