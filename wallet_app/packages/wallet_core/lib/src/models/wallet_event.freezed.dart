...
mixin _$WalletEvent {
 ...
 String get id; String get dateTime;
...
/// Create a copy of WalletEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? dateTime = null,}) {
...
@pragma('vm:prefer-inline')
$WalletEvent_DisclosureCopyWith<WalletEvent_Disclosure> get copyWith => _$WalletEvent_DisclosureCopyWithImpl<WalletEvent_Disclosure>(this, _$identity);
...
abstract mixin class $WalletEvent_DisclosureCopyWith<$Res> implements $WalletEventCopyWith<$Res> {
  factory $WalletEvent_DisclosureCopyWith(WalletEvent_Disclosure value, $Res Function(WalletEvent_Disclosure) _then) = _$WalletEvent_DisclosureCopyWithImpl;
@override @useResult
$Res call({
 String id, String dateTime, Organization relyingParty, List<LocalizedString> purpose, List<AttestationPresentation>? sharedAttestations, RequestPolicy requestPolicy, DisclosureStatus status, DisclosureType typ
});
...
/// @nodoc
class _$WalletEvent_DisclosureCopyWithImpl<$Res>
    implements $WalletEvent_DisclosureCopyWith<$Res> {
...
/// Create a copy of WalletEvent
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? dateTime = null,Object? relyingParty = null,Object? purpose = null,Object? sharedAttestations = freezed,Object? requestPolicy = null,Object? status = null,Object? typ = null,}) {
  return _then(WalletEvent_Disclosure(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,dateTime: null == dateTime ? _self.dateTime : dateTime // ignore: cast_nullable_to_non_nullable
as String,relyingParty: null == relyingParty ? _self.relyingParty : relyingParty // ignore: cast_nullable_to_non_nullable
as Organization,purpose: null == purpose ? _self._purpose : purpose // ignore: cast_nullable_to_non_nullable
as List<LocalizedString>,sharedAttestations: freezed == sharedAttestations ? _self._sharedAttestations : sharedAttestations // ignore: cast_nullable_to_non_nullable
as List<AttestationPresentation>?,requestPolicy: null == requestPolicy ? _self.requestPolicy : requestPolicy // ignore: cast_nullable_to_non_nullable
as RequestPolicy,status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as DisclosureStatus,typ: null == typ ? _self.typ : typ // ignore: cast_nullable_to_non_nullable
as DisclosureType,
  ));
}
...
class WalletEvent_Issuance extends WalletEvent {
  const WalletEvent_Issuance({required this.id, required this.dateTime, required this.attestation, required this.renewed}): super._();
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$WalletEvent_IssuanceCopyWith<WalletEvent_Issuance> get copyWith => _$WalletEvent_IssuanceCopyWithImpl<WalletEvent_Issuance>(this, _$identity);
...
abstract mixin class $WalletEvent_IssuanceCopyWith<$Res> implements $WalletEventCopyWith<$Res> {
  factory $WalletEvent_IssuanceCopyWith(WalletEvent_Issuance value, $Res Function(WalletEvent_Issuance) _then) = _$WalletEvent_IssuanceCopyWithImpl;
@override @useResult
$Res call({
 String id, String dateTime, AttestationPresentation attestation, bool renewed
});
...
/// @nodoc
class _$WalletEvent_IssuanceCopyWithImpl<$Res>
    implements $WalletEvent_IssuanceCopyWith<$Res> {
...
/// Create a copy of WalletEvent
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? dateTime = null,Object? attestation = null,Object? renewed = null,}) {
