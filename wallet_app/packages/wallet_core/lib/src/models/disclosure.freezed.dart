...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( AcceptDisclosureResult_Ok value)?  ok,TResult Function( AcceptDisclosureResult_InstructionError value)?  instructionError,required TResult orElse(),}){
final _that = this;
switch (_that) {
case AcceptDisclosureResult_Ok() when ok != null:
return ok(_that);case AcceptDisclosureResult_InstructionError() when instructionError != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( AcceptDisclosureResult_Ok value)  ok,required TResult Function( AcceptDisclosureResult_InstructionError value)  instructionError,}){
final _that = this;
switch (_that) {
case AcceptDisclosureResult_Ok():
return ok(_that);case AcceptDisclosureResult_InstructionError():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( AcceptDisclosureResult_Ok value)?  ok,TResult? Function( AcceptDisclosureResult_InstructionError value)?  instructionError,}){
final _that = this;
switch (_that) {
case AcceptDisclosureResult_Ok() when ok != null:
return ok(_that);case AcceptDisclosureResult_InstructionError() when instructionError != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String? returnUrl)?  ok,TResult Function( WalletInstructionError error)?  instructionError,required TResult orElse(),}) {final _that = this;
switch (_that) {
case AcceptDisclosureResult_Ok() when ok != null:
return ok(_that.returnUrl);case AcceptDisclosureResult_InstructionError() when instructionError != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String? returnUrl)  ok,required TResult Function( WalletInstructionError error)  instructionError,}) {final _that = this;
switch (_that) {
case AcceptDisclosureResult_Ok():
return ok(_that.returnUrl);case AcceptDisclosureResult_InstructionError():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String? returnUrl)?  ok,TResult? Function( WalletInstructionError error)?  instructionError,}) {final _that = this;
switch (_that) {
case AcceptDisclosureResult_Ok() when ok != null:
return ok(_that.returnUrl);case AcceptDisclosureResult_InstructionError() when instructionError != null:
return instructionError(_that.error);case _:
...
$AcceptDisclosureResult_OkCopyWith<AcceptDisclosureResult_Ok> get copyWith => _$AcceptDisclosureResult_OkCopyWithImpl<AcceptDisclosureResult_Ok>(this, _$identity);
...
abstract mixin class $AcceptDisclosureResult_OkCopyWith<$Res> implements $AcceptDisclosureResultCopyWith<$Res> {
  factory $AcceptDisclosureResult_OkCopyWith(AcceptDisclosureResult_Ok value, $Res Function(AcceptDisclosureResult_Ok) _then) = _$AcceptDisclosureResult_OkCopyWithImpl;
@useResult
$Res call({
 String? returnUrl
});
...
/// @nodoc
class _$AcceptDisclosureResult_OkCopyWithImpl<$Res>
    implements $AcceptDisclosureResult_OkCopyWith<$Res> {
...
/// Create a copy of AcceptDisclosureResult
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? returnUrl = freezed,}) {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$AcceptDisclosureResult_InstructionErrorCopyWith<AcceptDisclosureResult_InstructionError> get copyWith => _$AcceptDisclosureResult_InstructionErrorCopyWithImpl<AcceptDisclosureResult_InstructionError>(this, _$identity);
...
/// @nodoc
abstract mixin class $AcceptDisclosureResult_InstructionErrorCopyWith<$Res> implements $AcceptDisclosureResultCopyWith<$Res> {
  factory $AcceptDisclosureResult_InstructionErrorCopyWith(AcceptDisclosureResult_InstructionError value, $Res Function(AcceptDisclosureResult_InstructionError) _then) = _$AcceptDisclosureResult_InstructionErrorCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( CloseProximityDisclosureFlutterUpdate_Connecting value)?  connecting,TResult Function( CloseProximityDisclosureFlutterUpdate_Connected value)?  connected,TResult Function( CloseProximityDisclosureFlutterUpdate_DisclosureStarted value)?  disclosureStarted,TResult Function( CloseProximityDisclosureFlutterUpdate_Disconnected value)?  disconnected,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return connected(_that);case CloseProximityDisclosureFlutterUpdate_DisclosureStarted() when disclosureStarted != null:
return disclosureStarted(_that);case CloseProximityDisclosureFlutterUpdate_Disconnected() when disconnected != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( CloseProximityDisclosureFlutterUpdate_Connecting value)  connecting,required TResult Function( CloseProximityDisclosureFlutterUpdate_Connected value)  connected,required TResult Function( CloseProximityDisclosureFlutterUpdate_DisclosureStarted value)  disclosureStarted,required TResult Function( CloseProximityDisclosureFlutterUpdate_Disconnected value)  disconnected,}){
final _that = this;
switch (_that) {
...
return connected(_that);case CloseProximityDisclosureFlutterUpdate_DisclosureStarted():
return disclosureStarted(_that);case CloseProximityDisclosureFlutterUpdate_Disconnected():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( CloseProximityDisclosureFlutterUpdate_Connecting value)?  connecting,TResult? Function( CloseProximityDisclosureFlutterUpdate_Connected value)?  connected,TResult? Function( CloseProximityDisclosureFlutterUpdate_DisclosureStarted value)?  disclosureStarted,TResult? Function( CloseProximityDisclosureFlutterUpdate_Disconnected value)?  disconnected,}){
final _that = this;
switch (_that) {
case CloseProximityDisclosureFlutterUpdate_Connecting() when connecting != null:
return connecting(_that);case CloseProximityDisclosureFlutterUpdate_Connected() when connected != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  connecting,TResult Function()?  connected,TResult Function( StartDisclosureResult result)?  disclosureStarted,TResult Function()?  disconnected,required TResult orElse(),}) {final _that = this;
switch (_that) {
case CloseProximityDisclosureFlutterUpdate_Connecting() when connecting != null:
return connecting();case CloseProximityDisclosureFlutterUpdate_Connected() when connected != null:
return connected();case CloseProximityDisclosureFlutterUpdate_DisclosureStarted() when disclosureStarted != null:
return disclosureStarted(_that.result);case CloseProximityDisclosureFlutterUpdate_Disconnected() when disconnected != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  connecting,required TResult Function()  connected,required TResult Function( StartDisclosureResult result)  disclosureStarted,required TResult Function()  disconnected,}) {final _that = this;
switch (_that) {
case CloseProximityDisclosureFlutterUpdate_Connecting():
return connecting();case CloseProximityDisclosureFlutterUpdate_Connected():
return connected();case CloseProximityDisclosureFlutterUpdate_DisclosureStarted():
return disclosureStarted(_that.result);case CloseProximityDisclosureFlutterUpdate_Disconnected():
return disconnected();}
}
/// A variant of `when` that fallback to returning `null`
///
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  connecting,TResult? Function()?  connected,TResult? Function( StartDisclosureResult result)?  disclosureStarted,TResult? Function()?  disconnected,}) {final _that = this;
switch (_that) {
case CloseProximityDisclosureFlutterUpdate_Connecting() when connecting != null:
return connecting();case CloseProximityDisclosureFlutterUpdate_Connected() when connected != null:
return connected();case CloseProximityDisclosureFlutterUpdate_DisclosureStarted() when disclosureStarted != null:
...
class CloseProximityDisclosureFlutterUpdate_DisclosureStarted extends CloseProximityDisclosureFlutterUpdate {
  const CloseProximityDisclosureFlutterUpdate_DisclosureStarted({required this.result}): super._();
  

 final  StartDisclosureResult result;

/// Create a copy of CloseProximityDisclosureFlutterUpdate
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$CloseProximityDisclosureFlutterUpdate_DisclosureStartedCopyWith<CloseProximityDisclosureFlutterUpdate_DisclosureStarted> get copyWith => _$CloseProximityDisclosureFlutterUpdate_DisclosureStartedCopyWithImpl<CloseProximityDisclosureFlutterUpdate_DisclosureStarted>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CloseProximityDisclosureFlutterUpdate_DisclosureStarted&&(identical(other.result, result) || other.result == result));
}
...
@override
String toString() {
  return 'CloseProximityDisclosureFlutterUpdate.disclosureStarted(result: $result)';
}
...
/// @nodoc
abstract mixin class $CloseProximityDisclosureFlutterUpdate_DisclosureStartedCopyWith<$Res> implements $CloseProximityDisclosureFlutterUpdateCopyWith<$Res> {
  factory $CloseProximityDisclosureFlutterUpdate_DisclosureStartedCopyWith(CloseProximityDisclosureFlutterUpdate_DisclosureStarted value, $Res Function(CloseProximityDisclosureFlutterUpdate_DisclosureStarted) _then) = _$CloseProximityDisclosureFlutterUpdate_DisclosureStartedCopyWithImpl;
@useResult
$Res call({
 StartDisclosureResult result
});


$StartDisclosureResultCopyWith<$Res> get result;

}
/// @nodoc
class _$CloseProximityDisclosureFlutterUpdate_DisclosureStartedCopyWithImpl<$Res>
    implements $CloseProximityDisclosureFlutterUpdate_DisclosureStartedCopyWith<$Res> {
  _$CloseProximityDisclosureFlutterUpdate_DisclosureStartedCopyWithImpl(this._self, this._then);

  final CloseProximityDisclosureFlutterUpdate_DisclosureStarted _self;
  final $Res Function(CloseProximityDisclosureFlutterUpdate_DisclosureStarted) _then;

/// Create a copy of CloseProximityDisclosureFlutterUpdate
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? result = null,}) {
  return _then(CloseProximityDisclosureFlutterUpdate_DisclosureStarted(
result: null == result ? _self.result : result // ignore: cast_nullable_to_non_nullable
as StartDisclosureResult,
  ));
}
...
$StartDisclosureResultCopyWith<$Res> get result {
  ...
  return $StartDisclosureResultCopyWith<$Res>(_self.result, (value) {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( StartDisclosureResult_Request value)?  request,TResult Function( StartDisclosureResult_RequestAttributesMissing value)?  requestAttributesMissing,required TResult orElse(),}){
final _that = this;
switch (_that) {
case StartDisclosureResult_Request() when request != null:
return request(_that);case StartDisclosureResult_RequestAttributesMissing() when requestAttributesMissing != null:
return requestAttributesMissing(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( StartDisclosureResult_Request value)  request,required TResult Function( StartDisclosureResult_RequestAttributesMissing value)  requestAttributesMissing,}){
final _that = this;
switch (_that) {
case StartDisclosureResult_Request():
return request(_that);case StartDisclosureResult_RequestAttributesMissing():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( StartDisclosureResult_Request value)?  request,TResult? Function( StartDisclosureResult_RequestAttributesMissing value)?  requestAttributesMissing,}){
final _that = this;
switch (_that) {
case StartDisclosureResult_Request() when request != null:
return request(_that);case StartDisclosureResult_RequestAttributesMissing() when requestAttributesMissing != null:
...
@override final  Organization relyingParty;
 ...
 final  List<DisclosureOptions> _disclosureOptions;
 List<DisclosureOptions> get disclosureOptions {
  if (_disclosureOptions is EqualUnmodifiableListView) return _disclosureOptions;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_disclosureOptions);
}

@override final  bool sharedDataWithRelyingPartyBefore;
@override final  DisclosureSessionType sessionType;
 final  List<LocalizedString> _requestPurpose;
@override List<LocalizedString> get requestPurpose {
...
@pragma('vm:prefer-inline')
$StartDisclosureResult_RequestCopyWith<StartDisclosureResult_Request> get copyWith => _$StartDisclosureResult_RequestCopyWithImpl<StartDisclosureResult_Request>(this, _$identity);
...
/// @nodoc
class _$StartDisclosureResult_RequestCopyWithImpl<$Res>
    implements $StartDisclosureResult_RequestCopyWith<$Res> {
...
as RequestPolicy,disclosureOptions: null == disclosureOptions ? _self._disclosureOptions : disclosureOptions // ignore: cast_nullable_to_non_nullable
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$StartDisclosureResult_RequestAttributesMissingCopyWith<StartDisclosureResult_RequestAttributesMissing> get copyWith => _$StartDisclosureResult_RequestAttributesMissingCopyWithImpl<StartDisclosureResult_RequestAttributesMissing>(this, _$identity);
...
/// @nodoc
abstract mixin class $StartDisclosureResult_RequestAttributesMissingCopyWith<$Res> implements $StartDisclosureResultCopyWith<$Res> {
