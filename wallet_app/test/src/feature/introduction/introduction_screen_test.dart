...
void main() {
  group('goldens', () {
    ...
    testGoldens('ltc12 Page 2 light', (tester) async {
      await tester.pumpWidgetWithAppWrapper(const IntroductionScreen());
      await _skipPage(tester);
      await screenMatchesGolden('page_2.light');
    });

    testGoldens('ltc12 Page 3 light', (tester) async {
    ...
    testGoldens('ltc12 Page 1 dark', (tester) async {
      await tester.pumpWidgetWithAppWrapper(
        const IntroductionScreen(),
    ...
    testGoldens('ltc12 Page 1 individual to render portrait and thus show stepper correctly', (tester) async {
      await tester.pumpWidgetWithAppWrapper(const IntroductionScreen());
  ...
  group('widgets', () {
    testWidgets('ltc12 page 1 title and description are shown', (WidgetTester tester) async {
      await tester.pumpWidgetWithAppWrapper(const IntroductionScreen());
    ...
    testWidgets('ltc12 play/pause button initially shows pause icon', (WidgetTester tester) async {
      await tester.pumpWidgetWithAppWrapper(const IntroductionScreen());

      expect(find.byIcon(Icons.pause_outlined), findsOneWidget);
    });

    testWidgets('ltc12 play/pause button shows play icon after tapping it', (WidgetTester tester) async {
      await tester.pumpWidgetWithAppWrapper(const IntroductionScreen());
    ...
    testWidgets('ltc12 page 2 title and description are shown', (WidgetTester tester) async {
    ...
    testWidgets('ltc12 page 3 title and description are shown', (WidgetTester tester) async {
      const Key key = Key('introduction');
      await tester.pumpWidgetWithAppWrapper(const IntroductionScreen(key: key));
