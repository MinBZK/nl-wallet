...
import 'package:wallet/src/util/formatter/card/status/impl/card_status_metadata_wallet_item_formatter.dart';

void main() {
  final mockDateTime = DateTime.now();

  late CardStatusMetadataWalletItemFormatter formatter;
  ...
  group('show', () {
    ...
    test('returns true for expiresSoon status', () {
      expect(formatter.show(CardStatusExpiresSoon(validUntil: mockDateTime)), true);
    });
