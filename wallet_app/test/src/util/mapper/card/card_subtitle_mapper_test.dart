...
final _kSampleNameSubtitle = {const Locale('en'): 'Willeke', const Locale('nl'): 'Willeke'};
final _kSampleCitySubtitle = {const Locale('en'): 'Den Haag', const Locale('nl'): 'Den Haag'};
